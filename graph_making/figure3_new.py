...
plt.text(0.15,0.85,'(a)', color='white',fontsize=16, transform=ax1.transAxes, \
        fontproperties=tnr, ha='center',va='center')
plt.text(0.8,0.8,r'$\times$ 72', color='white',fontsize=16, transform=ax1.transAxes, \
        fontproperties=tnr, ha='center',va='center')        
...
cl=cbar.ax.set_yticklabels([r'0',r'4.5$\times$$10^{-3}$',\
                     r'9.0$\times$$10^{-3}$',r'1.3$\times$$10^{-2}$',\
                     r'1.8$\times$$10^{-2}$'],fontsize=13,fontproperties=tnr)
...
plt.xticks([1,25,50,75,101],['','','','',''],fontsize=14,fontproperties=tnr)
plt.yticks([1,25,50,75,101],['','','','',''],fontsize=14,fontproperties=tnr)
plt.text(0.15,0.85,'(b)', color='white',fontsize=16, transform=ax2.transAxes, \
        fontproperties=tnr, ha='center',va='center')
...
plt.xticks([1,25,50,75,101],fontsize=14,fontproperties=tnr)
plt.yticks([1,25,50,75,101],fontsize=14,fontproperties=tnr)
plt.text(0.15,0.85,'(c)', color='white',fontsize=16, transform=ax3.transAxes, \
        fontproperties=tnr, ha='center',va='center')
...
plt.tick_params(direction='out', bottom='on', top='off', left='on', right='off')
im4=plt.imshow(p4, origin='lower', extent=[1,nx,1,ny]) #,cmap='PuRd'
plt.clim(pmin0,pmax0)
#plt.xlabel('x',labelpad=5,fontsize=20,fontproperties=tnri)
#plt.ylabel('y',labelpad=5,fontsize=20,fontproperties=tnri)
plt.xlim(1,nx)
...
plt.xticks([1,25,50,75,101],['','','','',''], fontsize=14,fontproperties=tnr)
plt.yticks([1,25,50,75,101],['','','','',''],fontsize=14,fontproperties=tnr)
plt.text(0.15,0.85,'(d)', color='white',fontsize=16, transform=ax4.transAxes, \
        fontproperties=tnr, ha='center',va='center')
