...
subplot_hspace = 0.05
subplot_wspace = 0.0
AC_label_x_position = 0.18
AC_label_y_position = 0.85
#left_hspace_2 = 0.2
...
axA.plot(site0,probability0*20,'k--', site1, probability1, 'r-', site2, probability2, 'b-')
axA.set_xlabel('Site index', fontsize=18,fontproperties=tnr)
axA.set_ylabel('Probability', fontsize=18,fontproperties=tnr)
axA.text(0.18,0.85,'(a)',fontsize=18,transform=axA.transAxes,fontproperties=tnr)
axA.text(0.09,0.16,r'$\times$ 20',fontsize=16,transform=axA.transAxes,fontproperties=tnr)
...
axC.tick_params(direction='out',bottom='on', top='off', left='on', right='off')
...
axC.set_xlim(1, 1001)
axC.set_ylim(0, 0.036)
ytick_position = np.linspace(0,0.036,5)
xtick_number=6
xtick_position =np.linspace(0,1001,xtick_number)
plt.xticks(xtick_position, ['1', '200', '400','600','800','1001'],fontsize=16,fontproperties=tnr)
plt.yticks(ytick_position, ['0', '0.009','0.018','0.027','0.036'], fontsize=16,fontproperties=tnr)           
axC.plot(site0,probability0*5,'k--', site1, probability1, 'r-', site2, probability2, 'b-')
axC.set_xlabel('Site index', fontsize=18,fontproperties=tnr)
axC.set_ylabel('Probability', fontsize=18,fontproperties=tnr)
axC.text(0.18,0.85,'(c)',fontsize=18,transform=axC.transAxes,fontproperties=tnr)
axC.text(0.09,0.14,r'$\times$ 5',fontsize=16,transform=axC.transAxes,fontproperties=tnr)
...
# time evolution for the plane wave case##################################################################################
nx = 1001
ny = 1001
...
axB.set_xlabel(r'Time ($m$s)',fontsize=18,fontproperties=tnr)
axB.set_ylabel('Site index',fontsize=18,fontproperties=tnr)
axB.text(AC_label_x_position,AC_label_y_position,'(b)',fontsize=18,color='black',transform=axB.transAxes,fontproperties=tnr)
############################################################################################################################
...
# time evolution for the wavepacket case##################################################################################
plt.tick_params(direction='out',bottom='on', top='off', left='on', right='off')
nx = 1001
ny = 1001
...
axD.set_xlabel(r'Time ($m$s)',fontsize=18,fontproperties=tnr)
axD.set_ylabel('Site index',fontsize=18,fontproperties=tnr)
axD.text(AC_label_x_position,AC_label_y_position,'(d)',fontsize=18,color='black',transform=axD.transAxes,fontproperties=tnr)
############################################################################################################################
