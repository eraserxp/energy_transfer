...
cl=cbar.ax.set_yticklabels([r'0',r'1.2$\times$$10^{-3}$',\
                     r'2.3$\times$$10^{-3}$',r'3.5$\times$$10^{-3}$',\
                     r'4.7$\times$$10^{-3}$'],fontsize=13,fontproperties=tnr)
...
plt.savefig('focusing-with-vacancy.pdf', bbox_inches='tight', dpi=300)
plt.show()
